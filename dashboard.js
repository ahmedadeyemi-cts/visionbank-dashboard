...
async function loadAgentStatus() {
    ...
    try {
        ...
        agents.forEach(a => {
            ...
            // Correct field mappings based on API values
            const answered = a.TotalCallsReceived || 0;
            const missed = a.TotalCallsMissed || 0;
            const transferred = a.ThridPartyTransferCount || 0;
            const outbound = a.TotalCallsOnACW || 0;  // best available match
            ...
            html += `
                <tr class="${rowClass}">
                    ...
                    <td>${formatSecondsToHHMMSS(a.NormalOtherInterval || 0)}</td>
